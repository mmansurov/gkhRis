namespace Bars.Gkh.Ris.Tasks.HouseManagement
{
    ...
    /// </summary>
    public class ExportContractDataTask : BaseExportTask<getStateResult, HouseManagementPortsTypeAsyncClient>
    {
        /// <summary>
            ...
            Dictionary<Type, Dictionary<string, long>> transportGuidDictByType)
        {
            ...
            var contractsByTransportGuid = transportGuidDictByType[typeof(RisContract)];
        ...
        {
            var domain = this.Container.ResolveDomain<RisContract>();
