namespace Bars.Gkh.Ris.Integration.Inspection
{
    using System;
    using B4.Utils;
    using Entities;
    ...
    public abstract class GisIntegrationInspectionMethod<T, K> : GisIntegrationMethodBase<T, K, InspectionPortsTypeClient>
