namespace Bars.Gkh.Ris.Integration.DeviceMetering
{
    using System;
    using B4.Utils;
    using Entities;
    ...
    public abstract class GisIntegrationDeviceMeteringMethod<T, K> : GisIntegrationMethodBase<T, K, DeviceMeteringPortTypesClient> where T : BaseRisEntity
    {
        /// <summary>
        /// Заголовок запроса
        /// </summary>
