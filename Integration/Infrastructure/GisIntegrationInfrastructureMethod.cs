namespace Bars.Gkh.Ris.Integration.Infrastructure
{
    using B4.Utils;
    using Entities;
    ...
    public abstract class GisIntegrationInfrastructureMethod<T, K> : GisIntegrationMethodBase<T, K, InfrastructurePortsTypeClient> where T : BaseRisEntity
    {
        /// <summary>
        /// Заголовок запроса
        /// </summary>
